...
import { signInWithGoogle, signUpWithEmail, sendPhoneVerificationCode, verifyPhoneCode, initializeRecaptcha, formatPhoneNumber, resetRecaptcha } from '@/lib/firebaseAuth';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-4 bg-[#18181B] text-[#ADADAD]">Or sign up with</span>
              </div>
            </div>
